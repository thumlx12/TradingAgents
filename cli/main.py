...
def display_complete_report(final_state, report_dir):
    ...
    if final_state.get("market_report"):
        ...
        md_content.append(adjust_markdown_headers(final_state["market_report"]))
    ...
    if final_state.get("sentiment_report"):
        ...
        md_content.append(adjust_markdown_headers(final_state["sentiment_report"]))
        md_content.append("")  # Empty line for spacing
    ...
    if final_state.get("fundamentals_report"):
        ...
        md_content.append(adjust_markdown_headers(final_state["fundamentals_report"]))
        md_content.append("")  # Empty line for spacing
    ...
    if final_state.get("investment_debate_state"):
        ...
        if debate_state.get("bull_history"):
            ...
            md_content.append(adjust_markdown_headers(debate_state["bull_history"]))
            md_content.append("")  # Empty line for spacing
        ...
        if debate_state.get("bear_history"):
            ...
            md_content.append(adjust_markdown_headers(debate_state["bear_history"]))
            md_content.append("")  # Empty line for spacing
        ...
        if debate_state.get("judge_decision"):
            ...
            md_content.append(adjust_markdown_headers(debate_state["judge_decision"]))
            md_content.append("")  # Empty line for spacing
    ...
    if final_state.get("trader_investment_plan"):
        ...
        md_content.append(adjust_markdown_headers(final_state["trader_investment_plan"]))
        md_content.append("")  # Empty line for spacing
    ...
    if final_state.get("risk_debate_state"):
        ...
        if risk_state.get("risky_history"):
            ...
            md_content.append(adjust_markdown_headers(risk_state["risky_history"]))
            md_content.append("")  # Empty line for spacing
        ...
        if risk_state.get("safe_history"):
            ...
            md_content.append(adjust_markdown_headers(risk_state["safe_history"]))
            md_content.append("")  # Empty line for spacing
        ...
        if risk_state.get("neutral_history"):
            ...
            md_content.append(adjust_markdown_headers(risk_state["neutral_history"]))
            md_content.append("")  # Empty line for spacing
        ...
        if risk_state.get("judge_decision"):
            ...
            md_content.append(adjust_markdown_headers(risk_state["judge_decision"]))
...
def run_analysis():
    ...
    with Live(layout, refresh_per_second=4) as live:
        ...
        display_complete_report(final_state, report_dir)
